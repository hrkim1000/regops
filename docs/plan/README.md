...
| 2.0a | [phase2.0a_fda.md](phase2.0a_fda.md) | Phase 2 · M5–12 | — | ⬜ planned — `fda_samd` + `fda_cosmetic`, both together. **Recon and the ADRs are done** ([spike-2026-08-24](../design/spike-2026-08-24-fda-source-recon.md), [ADR-0018](../design/ADR-0018-fda-source-model.md)); **Phase 1 Go and the EU spike both resolved 2026-08-24.** Remaining *Prerequisite*: **an FDA-side `ra`** — the last thing between this slice and its start |
